          ...
          <div class="row">
            <div class="col-md pt-5">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-4">
                    ...
                    <div class="pb-3">
                      ...
                      <button
                        type="button"
                        class="btn btn-primary align-bottom btn-lg mr-1"
                      >
                        Large
                      </button>
                      ...
                      <button
                        type="button"
                        class="btn btn-primary align-bottom btn-sm mr-1"
                      >
                        Small
                      </button>
                  ...
                  <div class="col-lg-8 text-right">
                    <!-- Button toolbar -->
                    <div
                      class="btn-toolbar d-inline-block mb-3"
                      role="toolbar"
                  ...
                  <div class="col-12 py-4">
                    ...
                    <button class="btn btn-secondary mr-1 mb-1">
                      Secondary
                    </button>
                    ...
                    <button class="btn btn-light border mr-1 mb-1">
                      Light
                    </button>
                  ...
                  <div class="col-xl-9 pb-4">
                    ...
                    <div class="tab-content px-1 pt-2">
                      <div class="tab-pane active" id="tab1">
                        <p>
                          Welcome to my custom Bootstrap 4 test page that is a
                          simple way to see various Bootstrap component
                          examples.
                        </p>
                      ...
                      <div class="tab-pane" id="tab2">
                        2. Put a little content in your pane.
                      </div>
                    ...
                    <ul class="nav nav-pills flex-column mb-3">
                      <li class="nav-item">
                        <a
                          ...
                          data-trigger="hover"
                          data-placement="top"
                          data-title="Primary color"
                          data-content="Links and 'active' elements always use the primary color."
                          >Active</a
                        >
                      </li>
                      <li class="nav-item">
              ...
              <section id="grid" class="py-3">
                <p class="lead">
                  The rows &amp; columns of the world famous Bootstrap grid
                    ...
                    <div class="card border-primary h-100">
                      ...
                      >
                        ...
                        <p class="card-text">
                          ...
                          additional content. This has text that may wrap to the
                          next line.
                        </p>
                  ...
                  <div class="col-xl-12 col-lg-4 mb-4">
                    <div class="card bg-primary text-white h-100">
                      ...
                      >
                        ...
                        <p class="card-text">
                          Watch me scale, scale. Now watch me stack, stack.
                          Watch me scale, scale...
                        </p>
                        <a href="#" class="btn btn-primary border-white mt-auto"
                          >Button</a
                        >
                      </div>
                    </div>
                  ...
                  <div class="col-md-12">
                    ...
                    <form role="form">
                      <div class="form-group row">
                        <label
                          class="col-md-2 col-form-label form-control-label text-muted"
                          >First</label
                        >
                        <div class="col-md-4">
                          <input
                        ...
                        <label
                          class="col-md-1 col-form-label form-control-label text-muted"
                          >Last</label
                        >
                        <div class="col-md-5">
                          <input
                      ...
                      <div class="form-group row">
                        <label
                          class="col-lg-2 col-form-label form-control-label text-muted"
                          >Address</label
                        >
                        <div class="col-lg-10">
                          <input
              ...
              <section id="more" class="py-2">
                <div class="row">
                  ...
                  <div class="col-md-12">
                    <!-- Alert -->
                    <div
                      class="alert alert-primary alert-dismissable show fade"
                      role="alert"
                    >
                      <button
                        type="button"
